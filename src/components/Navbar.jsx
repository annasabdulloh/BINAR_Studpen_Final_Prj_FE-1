  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            <div className="container">
              <a className="navbar-brand" href="#"><img src="/assets/img/logo web.png" alt="MyAIRFARE" width="200px" /></a>
              ...
              <div className="collapse navbar-collapse mx-auto" id="navbarNav">
                <ul className="navbar-nav fs-6 mx-auto justify-content-center align-items-center">
                  ...
                  <li className="nav-item mx-2">
                    <a className="nav-link" href="#"><img src="/assets/img/mdi_cart-minus.svg" alt="" /></a>
                  </li>
                  <li className="nav-item ">
                    <a className="nav-link" href="#"><img src="/assets/img/image 70.svg" alt="" /></a>
                  </li>
                  {/* <li className='nav-item'>
                  ...
                  <Link to='/register' className='btn btn-secondary mx-2'>Registrasi</Link>
