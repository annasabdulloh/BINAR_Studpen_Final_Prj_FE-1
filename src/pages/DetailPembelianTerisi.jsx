    ...
    <div>
        ...
        <div className='row d-flex justify-content-center align-content-center p-3'>
            ...
            <div className='col-sm-7'>
                <div className='p-3 bg-secondary text-primary fw-bold text-center bg-opacity-25 fs-4 border border-secondary border-bottom-0'>Detail Pesanan</div>
                <div className='card g-3 p-5 mx-auto rounded-0 border border-secondary border-top-0'>
                    ...
                    <div action='' className='col-12'>
                        <div className='row d-flex pt-1 p-1 mb-2 align-content-center justify-content-center'>
                            ...
                            <div className='col-md-6 my-3'>
                                <Link to='/detailpembelian' className='fw-bold' style={{textDecoration: 'none'}}>Lihat Detail</Link>
                            </div>
                        </div>
                        <table className="table table-bordered border-secondary">
                            <tbody>
                                <tr>
                                    <td colspan="2" className='text-primary'>Nomor Telepon</td>
                                    <td className='text-primary'>Email</td>
                                </tr>
                                <tr>
                                    <td colspan="2" className='text-secondary'>08123456789</td>
                    ...
                    <div class="d-flex justify-content-center align-items-center shadow mb-3 bg-body rounded">
                        <img className='p-3' src='./assets/images/image 39.svg'/>
                        Harga tiket yang harus di bayar
                        <div className='p-3 col-md-6 text-end text-danger fw-bold'>Rp. 4.500.000</div>
                    </div>
                    <div className='mb-5 text-secondary'>Harga bisa berubah setiap saat, pastikan anda tetap mengupdate</div>
