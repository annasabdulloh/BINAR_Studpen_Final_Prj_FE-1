    ...
    res
      ...
      .then((json) => {
        if (res.status === 200) {
          ...
          setLoading(false);
          if (json.user.access_level == 1 && json.active === true)
            navigate("/");
          else if (json.user.access_level == 1 && json.active === false)
                          ...
                          >
                            <GoogleLogin
                              ...
                              onSuccess={(credentialRes) => {
                                loginGoogle(credentialRes);
                              }}
                              onError={() => {
                                handleGoogleFailure("Error google login");
                              }}
                            ></GoogleLogin>
                          </GoogleOAuthProvider>
                        </div>
