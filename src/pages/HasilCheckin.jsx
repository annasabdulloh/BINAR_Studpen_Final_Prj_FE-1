            ...
            <div className="col-12">
              <div className="row pt-4 
                ...
                <div className="row
                  ...
                  <div className="col-md-4 my-3">
                    <div className="card g-3 p-1 mb-1 
                                    text-center 
                                    fw-bold 
                                    bg-secondary 
                                    bg-opacity-25">
                ...
                <table className="col-md-3 table 
                                  justify-content-center 
                                  align-content-center 
                                  mb-5">
              ...
              <div className="text-center">
                MyAIRFARE INDONESIA,
                JALAN RAYA SIRIH NO. 21 JAKARTA
              </div>
            </div>
          </div>
          <div className="col-md-12 d-flex 
                  ...
                  <div className="row pt-10 d-flex
                                  justify-content-center
                                  align-items-center
                                  p-3">
                    <div className="col-md-4 my-3">
                      <img 
                        src="/assets/img/image 37.svg">
                      </img>
